        ...
        <form method="POST">
            ...
            ?>
                <div class="form-group">
                    <label>Nome</label>
                    <input type="text" class="form-control" name="nome"  maxlength="50" required value="<?php echo $linha['name']; ?>">
                </div>
                <input type="hidden" name="id" value="<?php echo $linha['id'] ?>">
                <br>
                <?php echo $u->getMsg() ?>
                <a href="listagemTag.php" class="btn btn-primary">Voltar</a>

...
if ($u->getMsg() == '') {
    ...
    $cont = 0;
    $resultado = $u->readTagbyName($pesquisa);
} else {
...
<body>
    ...
    <main class="container">
        <nav class="navbar navbar-dark ">
            ...
            <form class="form-inline" action="listagemTag.php" method="POST">
                <input class="form-control mr-sm-2" type="search" autofocus maxlength="50" placeholder="Buscar por tag" name="busca">
                <button class="btn btn-primary my-2 my-sm-0" type="submit">Pesquisar</button>
                <br>
                <a href='cadastroTag.php' class='btn btn-warning my-2 my-sm-0'>Cadastrar Tag</a>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td width=150px>
                                <a href='edicaoTag.php?id=<?php echo $id ?>' class='btn btn-success btn-sm'>Editar</a>
                                <!-- Button trigger modal -->
                                <a href='excluirTag.php' class="btn btn-danger btn-sm" data-toggle="modal" data-target="#confirma" onclick="pegar_dados('<?php echo $id ?>', '<?php echo $name ?>')">
                                    Excluir
                                </a>
                            </td>
                        </tr>
        ...
        <br>
        <a href="cadastroTag.php" class="btn btn-success">Voltar</a>
        <!-- Modal -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="excluirTag.php" method="post">
                            <p>Deseja realmente excluir a tag <b id="tag"></b>?</p>
                            <input type="hidden" name="id" id="tag_code" value="">
                    </div>
        ...
        <script>
            function pegar_dados(id, nome) {
                document.getElementById('tag_code').value = id;
                document.getElementById('tag').innerHTML = nome;
            }
        </script>
    </main>
    <br><br>
